...
mkdir -p ~/.local/bin
cp mininet/util/m ~/.local/bin/mnh
sudo cp mininet/util/m /usr/local/bin/mnh
...
sudo rm -rf $tmpdir
mkdir -p ~/.local/bin/
cp tools/runtime_CLI.py ~/.local/bin/runtime_CLI.py
sudo cp tools/runtime_CLI.py /usr/local/bin/runtime_CLI.py
cd ..

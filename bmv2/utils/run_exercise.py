...
class ExerciseRunner:
    ...
    def __init__(self, topo_file, log_dir, pcap_dir,
        ...
        self.capture_traffic = topo['capture_traffic'] if 'capture_traffic' in topo else False
        self.run_workload = topo['run_workload'] if 'run_workload' in topo else False
        self.enable_debugger = topo['enable_debugger'] if 'enable_debugger' in topo else False
    ...
    def run_exercise(self):
        ...
        felix_experiment.run(self.net, self.do_net_cli)
        # else:
        #     self.do_net_cli()
